...
<body>
	...
	<form id="admin_xsgl_xsgl_importForm" method="post">
		Excel文件：<input type="file" id="uploadfile" name="file"
			style="width: 300px" /><br /> <a id="btn" href="#"
			class="easyui-linkbutton" onclick="xsImport()"
			data-options="iconCls:'icon-add'">导入</a>
	</form>
	<br>
	<br>
	<br> 考试开关：
	<input id="xsSwitch" class="easyui-switchbutton"
		data-options="onText:'NO',offText:'OFF',onChange:function(){xsChange();}">

	<div id="admin_xsgl_xsgl_rollingDialog" class="easyui-dialog"
