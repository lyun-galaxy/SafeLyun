...
<body>
	<script type="text/javascript">
		...
		function tkSearchFun() {
			...
			$('#admin_tkgl_tkgl_datagrid').datagrid('load',
					serializeObject($('#admin_tkgl_tkgl_searchForm')));
		}
			...
			$
					.ajaxFileUpload({
						...
						success : function(data) {
							...
							if (obj.success) {
								$('#admin_tkgl_tkgl_datagrid').datagrid('load');
								$('#admin_tkgl_tkgl_importDialog').dialog(
										'close');
							}
							$.messager.show({
								title : '提示',
	...
	<div id="admin_tkgl_tkgl_layout" class="easyui-layout"
		data-options="fit:true,border:false">
		<div data-options="region:'north',title:'查询条件',border:false"
			style="height: 100px;">
			<form id="admin_tkgl_tkgl_searchForm">
				检索题目(可模糊查询):<input name="name" /> </a> <a href="#"
					class="easyui-linkbutton" data-options="iconCls:'icon-search'"
					onclick="tkSearchFun()">查询</a> <a href="#"
					class="easyui-linkbutton" data-options="iconCls:'icon-back'"
					onclick="tkClearFun()">清空</a>
			</form>
			<br> <a href="#" class="easyui-linkbutton"
				data-options="iconCls:'icon-search'" onclick="tkUnAudit()">查看未审核</a>
		</div>
	...
	<div id="admin_tkgl_tkgl_importDialog" class="easyui-dialog"
		data-options="closed:true,modal:true,title:'添加题目',buttons:[{
					text : '添加',
					iconCls : 'icon-add',
					handler : function() {
						impInfo();	
		...
		<form id="admin_tkgl_tkgl_importForm" method="post">
			Excel文件：<input type="file" id="uploadfile" name="file"
				style="width: 300px">
		</form>

	</div>

	<div id="admin_tkgl_tkgl_rollingDialog" class="easyui-dialog"
		data-options="closed:true,modal:true,title:'提示'"
		style="width: 300px; height: 70px;" align="center">
		<img alt="上传中。。。" src="jslib/imgs/rolling.gif"><br> <a>上传中,请等候...</a>
	</div>

	<div id="admin_tkgl_tkgl_addDialog" class="easyui-dialog"
		data-options="closed:true,modal:true,title:'添加题目',buttons:[{
					text : '添加',
					iconCls : 'icon-add',
					handler : function() {
		...
		<form id="admin_tkgl_tkgl_addForm" method="post">
			<table>
				<tr>
					<th>修改人</th>
					<td><input name="uploadName" class="easyui-validatebox"
				...
				<tr>
					<th>A选项</th>
					<td><input name="a" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<th>B选项</th>
					<td><input name="b" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<th>C选项</th>
					<td><input name="c" class="easyui-validatebox" /></td>
				</tr>
				<tr>
					<th>D选项</th>
					<td><input name="d" class="easyui-validatebox" /></td>
				</tr>
				<tr align="left">
					<td>正确选项:</td>
