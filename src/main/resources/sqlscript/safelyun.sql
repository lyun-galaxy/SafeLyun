...
CREATE TABLE IF NOT EXISTS `safelyun`.`menu` (
  ...
  `parentMenuId` INT(11) NULL COMMENT '',
  PRIMARY KEY (`menuId`)  COMMENT '',
  UNIQUE INDEX `menuUrl_UNIQUE` (`menuUrl` ASC)  COMMENT '',
  INDEX `fk_menu_menu1_idx` (`parentMenuId` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `safelyun`.`section` (
  ...
  `sectionUploader` VARCHAR(45) NOT NULL COMMENT '',
  PRIMARY KEY (`sectionId`)  COMMENT '',
  UNIQUE INDEX `sectionCode_UNIQUE` (`sectionCode` ASC)  COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `safelyun`.`subsection` (
  ...
  `subsectionUploader` VARCHAR(45) NOT NULL COMMENT '',
  ...
  UNIQUE INDEX `subsectionCode_UNIQUE` (`subsectionCode` ASC)  COMMENT '',
